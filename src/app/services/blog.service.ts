...
export class BlogService {
  ...
  uploadCover(registrationNumber: string, blogId: string, file: File): Observable<{ url: string }> {
    ...
    fd.append('file', file);
    return this.httpService.sendPOSTRequest(`${this.baseUrl}/${safeDoctor}/blogs/${safeId}/upload/cover`, fd);
  }
  ...
  uploadDocument(registrationNumber: string, blogId: string, file: File): Observable<BlogDocument> {
    ...
    const fd = new FormData();
    fd.append('file', file);
    return this.httpService.sendPOSTRequest(`${this.baseUrl}/${safeDoctor}/blogs/${safeId}/upload/document`, fd);
  }
