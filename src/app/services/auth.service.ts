...
export class AuthService {
  ...
  /**
   * Resolve the logged-in doctor's public code (alias for registration number).
   * Use this when the API expects a "doctor public code" or "doctor code".
   */
  public getDoctorPublicCode(): string | null {
    return this.getDoctorRegistrationNumber();
  }
